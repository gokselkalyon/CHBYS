<%@ Page Title="" Language="C#" MasterPageFile="~/PanelMaster.Master" AutoEventWireup="true" CodeBehind="teklif.aspx.cs" Inherits="CHBYS.PRESENTATIONLAYER.teklif" %>
    ...
    <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                            ...
                            <div class="simple-card">
                                <ul class="nav nav-tabs nav-fill" id="myTab5" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active border-left-0" id="home-tab-simple" data-toggle="tab" href="#home-simple" role="tab" aria-controls="home" aria-selected="true"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Teklifler <i class="fas fa-angle-double-right" style="margin:10px;"></i> 1.Aşama</font></font></a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <form class="needs-validation" novalidate="">
                                                            <div class="mb-3">
                                                                <label for="country"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Müşteriyi Bulun</font></font></label>
                                                                <select class="custom-select d-block w-100" id="selectedMusteriyibulun" required="">
                                                                    <option value=""><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Veritabanındaki Müşteri Seçilir.</font></font></option>
                                                                </select>
                                                                <small class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Teklif verceğiniz müşteriyi bulun</font></font></small>
                                                            </div>
                                                            <hr class="mb-4">
                                                <asp:Button ID="btnMusterigetir" runat="server" Text="Müşteri Getir" class="btn btn-primary btn-lg btn-block" type="submit" />
                                                            <hr class="mb-4">
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="firstName"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Teklif No</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtTeklifno" value=""></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="firstName"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Geçerlilik</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtGecerlilik" value=""></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                            ...
                            <div class="simple-card">
                                <ul class="nav nav-tabs nav-fill" id="myTab5" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active border-left-0" id="home-tab-simple" data-toggle="tab" href="#home-simple" role="tab" aria-controls="home" aria-selected="true"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Teklifler <i class="fas fa-angle-double-right" style="margin:10px;"></i> 2.Aşama</font></font></a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="home-simple" role="tabpanel" aria-labelledby="home-tab-simple">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <hr class="mb-4">
                                                <asp:Button ID="btnTeklifikaydet" runat="server" Text="Teklifi Kaydet" class="btn btn-primary btn-lg btn-block" type="submit" />
                    ...
                    <div class="card">
                        <h5 class="card-header"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Teklifler Listesi</font></font></h5>
                        <div class="card-body">
