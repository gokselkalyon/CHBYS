<%@ Page Title="" Language="C#" MasterPageFile="~/PanelMaster.Master" AutoEventWireup="true" CodeBehind="musteriler.aspx.cs" Inherits="CHBYS.PRESENTATIONLAYER.musteriler" %>
   ...
   <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="card">
                        <h5 class="card-header"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Cari Listesi</font></font></h5>
                        <div class="card-body" style="width:100%; overflow:scroll; max-height:250px;">
                            <asp:GridView ID="gv1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" AutoGenerateSelectButton="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                &nbsp;
                                <li style="margin:3px;" class="fas fa-angle-right"></li> &nbsp;
                                <li>Cari Ekleme & İşlem Bilgileri</li>
                            </ol>
                                                    ...
                                                    <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="firstName"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">cari adı</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtaciklama" placeholder="" value="" ></asp:TextBox>

                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="lastName"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">unvan</font></font></label>
                                                                    <asp:TextBox ID="txtappellation" runat="server"  type="text" style="width:220px; padding:3px; "></asp:TextBox>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="firstName"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">city</font></font></label>
                                                                    <asp:DropDownList ID="ddlcity" class="form-control" runat="server"></asp:DropDownList>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="lastName"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">ilçe</font></font></label>
                                                                    <asp:DropDownList ID="ddlcounty" class="form-control" runat="server"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="username"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">ulke</font></font></label>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="address"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">adres</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtadress" placeholder="" value=""></asp:TextBox>
                                                            </div>
                                                        
                                                            <div class="mb-3">
                                                                <label for="address"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">posta kodu</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtpostcode" placeholder="" value=""></asp:TextBox>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="cc-name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">moblitelefon</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtmobilephone" placeholder="" value=""></asp:TextBox>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="cc-name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">telefon</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtphone" placeholder="" value=""></asp:TextBox>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="cc-name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">fax</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtfax" placeholder="" value=""></asp:TextBox>
                                                            </div>
                                                        
                                                            <div class="mb-3">
                                                                <label for="cc-name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">E-mail</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtemail" placeholder="example@example.com" value=""></asp:TextBox>
                                                            </div>

                                                            <hr class="mb-4">
                                                            <asp:Button ID="btnKaydet" runat="server" Text="Bilgileri Kaydet" class="btn btn-primary btn-lg btn-block" type="submit" OnClick="btnKaydet_Click" />
                                            ...
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="Vergi no"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Vergi numarası</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txttaxnumber" placeholder="" value=""></asp:TextBox>
                                                                    <div class="invalid-feedback">
                                                                        Valid first name is required.
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="Vergi D"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Vergi Dairesi</font></font></label>
                                                                    
                                                                    <asp:DropDownList ID="ddltaxadmin" class="custom-select d-block w-100" runat="server"></asp:DropDownList>
                                                                    <div class="invalid-feedback">
                                                                        Valid first name is required.
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="fatura"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">fatura tipi</font></font></label>
                                                                    <asp:DropDownList ID="ddleinvoicetype" class="custom-select d-block w-100" runat="server"></asp:DropDownList>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="payment_plan"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">payment_plan</font></font></label>
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="sektor"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">sektor</font></font></label>
                                                                    
                                                                    <asp:DropDownList ID="ddlsector" class="custom-select d-block w-100" runat="server"></asp:DropDownList>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="cari"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">cari kodu</font></font></label>
                                                                    <asp:TextBox type="text" runat="server" class="form-control" ID="txtsuppliers_Code" placeholder="" value=""></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="suppliers_type"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">caritipi</font></font></label>
                                                                    <asp:DropDownList ID="ddlsupptype" class="custom-select d-block w-100" runat="server"></asp:DropDownList>
